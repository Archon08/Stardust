...
--[[
	Tier 2 -- tatooine_rebel_tier2 Main Missions
]]

-- Mission 1: Inspect with surprise attack side quest
inspect_tatooine_rebel_tier2_1 = SpaceInspectScreenplay:new {
	className = "inspect_tatooine_rebel_tier2_1",

	questName = "tatooine_rebel_tier2_1",
	questType = "inspect",
	...
	sideQuest = true,
	sideQuestType = "destroy_surpriseattack",
	sideQuestName = "tatooine_rebel_tier2_1",
...
registerScreenPlay("inspect_tatooine_rebel_tier2_1", true)

destroy_surpriseattack_tatooine_rebel_tier2_1 = SpaceSurpriseAttackScreenplay:new {
	className = "destroy_surpriseattack_tatooine_rebel_tier2_1",
	...
	parentQuest = "inspect_tatooine_rebel_tier2_1",
	parentQuestType = "inspect",
	parentQuestName = "tatooine_rebel_tier2_1",
...
registerScreenPlay("destroy_surpriseattack_tatooine_rebel_tier2_1", true)

-- Mission 2: Escort (in Dantooine)
escort_tatooine_rebel_tier2_2 = SpaceEscortScreenplay:new {
	className = "escort_tatooine_rebel_tier2_2",

	questName = "tatooine_rebel_tier2_2",
	questType = "escort",
	...
	escortPoints = {
		{patrolPointName = "tatooine_rebel_tier2_2_1", zoneName = "space_dantooine", x = 1000, z = -900, y = -2100, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_2_2", zoneName = "space_dantooine", x = -28, z = -908, y = -2207, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_2_3", zoneName = "space_dantooine", x = -1158, z = -952, y = -2363, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_2_4", zoneName = "space_dantooine", x = -2566, z = -1057, y = -2599, escortNumber = 4, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_2_5", zoneName = "space_dantooine", x = -2436, z = -1574, y = -3167, escortNumber = 5, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_2_6", zoneName = "space_dantooine", x = -2129, z = -1970, y = -3738, escortNumber = 6, radius = 250},
	},
...
registerScreenPlay("escort_tatooine_rebel_tier2_2", true)

-- Mission 3: Recovery
recovery_tatooine_rebel_tier2_3 = SpaceRecoveryScreenplay:new {
	className = "recovery_tatooine_rebel_tier2_3",

	questName = "tatooine_rebel_tier2_3",
	questType = "recovery",
	...
	preRecoveryPoints = {
		{patrolPointName = "tatooine_rebel_tier2_3_target_1", zoneName = "space_lok", x = -5500, z = 3900, y = 3600, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_target_2", zoneName = "space_lok", x = -4775, z = 3294, y = 3140, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_target_3", zoneName = "space_lok", x = -3923, z = 2964, y = 2395, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_target_4", zoneName = "space_lok", x = -3191, z = 2904, y = 1706, escortNumber = 4, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_target_5", zoneName = "space_lok", x = -2496, z = 2865, y = 751, escortNumber = 5, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_target_6", zoneName = "space_lok", x = -1540, z = 2528, y = -1100, escortNumber = 6, radius = 250},
	},

	recoveryPoints = {
		{patrolPointName = "tatooine_rebel_tier2_3_recover_1", zoneName = "space_lok", x = -3381, z = 2517, y = 877, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_recover_2", zoneName = "space_lok", x = -3512, z = 1885, y = -192, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_recover_3", zoneName = "space_lok", x = -3723, z = 1223, y = -989, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_3_recover_4", zoneName = "space_lok", x = -4257, z = -227, y = -2707, escortNumber = 4, radius = 250},
	},
...
registerScreenPlay("recovery_tatooine_rebel_tier2_3", true)

-- Mission 4: Assassinate
assassinate_tatooine_rebel_tier2_4 = SpaceAssassinateScreenplay:new {
	className = "assassinate_tatooine_rebel_tier2_4",

	questType = "assassinate",
	questName = "tatooine_rebel_tier2_4",
	...
	targetPatrols = {
		{patrolPointName = "tatooine_rebel_tier2_four_1", x = 2800, z = 2400, y = 2800},
		{patrolPointName = "tatooine_rebel_tier2_four_2", x = 1662, z = 2407, y = 2790},
		{patrolPointName = "tatooine_rebel_tier2_four_3", x = 533, z = 2411, y = 3116},
		{patrolPointName = "tatooine_rebel_tier2_four_4", x = -1109, z = 2414, y = 3581},
		{patrolPointName = "tatooine_rebel_tier2_four_5", x = -2303, z = 2415, y = 4011},
		{patrolPointName = "tatooine_rebel_tier2_four_6", x = -3674, z = 2416, y = 4444},
	},
}

registerScreenPlay("assassinate_tatooine_rebel_tier2_4", true)

-- Tier 2 Duty Missions
destroy_duty_tatooine_rebel_tier2_destroyduty = SpaceDutyDestroyScreenplay:new {
	className = "destroy_duty_tatooine_rebel_tier2_destroyduty",

	questName = "tatooine_rebel_tier2_destroyduty",
	questType = "destroy_duty",
...
registerScreenPlay("destroy_duty_tatooine_rebel_tier2_destroyduty", true)

recovery_duty_tatooine_rebel_tier2_recoveryduty = SpaceDutyRecoveryScreenplay:new {
	className = "recovery_duty_tatooine_rebel_tier2_recoveryduty",

	questName = "tatooine_rebel_tier2_recoveryduty",
	...
	preRecoveryPoints = {
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_1", zoneName = "space_lok", x = -5007, z = -5499, y = -3499, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_2", zoneName = "space_lok", x = -6466, z = -6879, y = -4229, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_3", zoneName = "space_lok", x = -6974, z = -7081, y = -1544, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_4", zoneName = "space_lok", x = -7169, z = -6943, y = 1241, escortNumber = 4, radius = 250},
	},

	recoveryPoints = {
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_5", zoneName = "space_lok", x = -5700, z = -5955, y = -2034, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_6", zoneName = "space_lok", x = -5033, z = -4822, y = -3028, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_7", zoneName = "space_lok", x = -4768, z = -3941, y = -3678, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier2_recovery_duty_8", zoneName = "space_lok", x = -4757, z = -3078, y = -3964, escortNumber = 4, radius = 250},
	},
...
registerScreenPlay("recovery_duty_tatooine_rebel_tier2_recoveryduty", true)

escort_duty_tatooine_rebel_tier2_escortduty = SpaceDutyEscortScreenplay:new {
	className = "escort_duty_tatooine_rebel_tier2_escortduty",

	questName = "tatooine_rebel_tier2_escortduty",
	questType = "escort_duty",
...
--[[
	Tier 3 -- tatooine_rebel_tier3 Main Missions (missions-only tier)
]]
...
recovery_tatooine_rebel_tier3_1 = SpaceRecoveryScreenplay:new {
	...
	sideQuestName = "tatooine_rebel_tier3_1_A",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,
...
patrol_tatooine_rebel_tier3_1_A = SpacePatrolScreenplay:new {
	className = "patrol_tatooine_rebel_tier3_1_A",

	questName = "tatooine_rebel_tier3_1_A",
	questType = "patrol",
	...
	sideQuest = true,
	sideQuestType = "destroy_surpriseattack",
	sideQuestName = "tatooine_rebel_tier3_1_b",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.PATROL_POINT,

	sideQuestPatrolStart = 3,
	sideQuestDelay = 5,

	parentQuest = "recovery_tatooine_rebel_tier3_1",
	parentQuestType = "recovery",
	parentQuestName = "tatooine_rebel_tier3_1",
...
registerScreenPlay("patrol_tatooine_rebel_tier3_1_A", true)

-- Mission 1 Side Quest B: Destroy Surprise Attack (Space Yavin4 - Destroy Imperial patrol on escape path)
destroy_surpriseattack_tatooine_rebel_tier3_1_b = SpaceSurpriseAttackScreenplay:new {
	className = "destroy_surpriseattack_tatooine_rebel_tier3_1_b",

	questName = "tatooine_rebel_tier3_1_b",
	questType = "destroy_surpriseattack",
	...
	sideQuestName = "tatooine_rebel_tier3_1_c",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "patrol_tatooine_rebel_tier3_1_A",
	parentQuestType = "patrol",
	parentQuestName = "tatooine_rebel_tier3_1_A",
...
registerScreenPlay("destroy_surpriseattack_tatooine_rebel_tier3_1_b", true)

-- Mission 1 Side Quest C: Assassinate (Space Yavin4 - Stop Imperial scout patrol from escaping)
assassinate_tatooine_rebel_tier3_1_c = SpaceAssassinateScreenplay:new {
	className = "assassinate_tatooine_rebel_tier3_1_c",

	questType = "assassinate",
	questName = "tatooine_rebel_tier3_1_c",
	...
	sideQuestName = "tatooine_rebel_tier3_1_d",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "destroy_surpriseattack_tatooine_rebel_tier3_1_b",
	parentQuestType = "destroy_surpriseattack",
	parentQuestName = "tatooine_rebel_tier3_1_b",
...
registerScreenPlay("assassinate_tatooine_rebel_tier3_1_c", true)

-- Mission 1 Side Quest D: Space Battle (Space Yavin4 - Assist X-Wing squad against Imperial patrol)
space_battle_tatooine_rebel_tier3_1_d = SpaceBattleScreenplay:new {
	className = "space_battle_tatooine_rebel_tier3_1_d",

	questName = "tatooine_rebel_tier3_1_d",
	...
	parentQuest = "assassinate_tatooine_rebel_tier3_1_c",
	parentQuestType = "assassinate",
	parentQuestName = "tatooine_rebel_tier3_1_c",
...
registerScreenPlay("space_battle_tatooine_rebel_tier3_1_d", true)
...
inspect_tatooine_rebel_tier3_2 = SpaceInspectScreenplay:new {
	...
	sideQuestName = "tatooine_rebel_tier3_2_a",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,
...
delivery_tatooine_rebel_tier3_2_a = SpaceDeliveryScreenplay:new {
	className = "delivery_tatooine_rebel_tier3_2_a",

	questName = "tatooine_rebel_tier3_2_a",
	questType = "delivery",
	...
	sideQuestName = "tatooine_rebel_tier3_2_b",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 3,

	parentQuest = "inspect_tatooine_rebel_tier3_2",
	parentQuestType = "inspect",
	parentQuestName = "tatooine_rebel_tier3_2",
...
registerScreenPlay("delivery_tatooine_rebel_tier3_2_a", true)

-- Mission 2 Side Quest B: Survival (Space Endor - Defend fleet from Imperial fighter wings)
survival_tatooine_rebel_tier3_2_b = SpaceSurvivalScreenplay:new {
	className = "survival_tatooine_rebel_tier3_2_b",

	questName = "tatooine_rebel_tier3_2_b",
	questType = "survival",
	...
	sideQuest = true,
	sideQuestType = "escort",
	sideQuestName = "tatooine_rebel_tier3_2_c",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "delivery_tatooine_rebel_tier3_2_a",
	parentQuestType = "delivery",
	parentQuestName = "tatooine_rebel_tier3_2_a",
...
registerScreenPlay("survival_tatooine_rebel_tier3_2_b", true)

-- Mission 2 Side Quest C: Escort (Space Endor - Escort straggling freighter to new fleet position)
escort_tatooine_rebel_tier3_2_c = SpaceEscortScreenplay:new {
	className = "escort_tatooine_rebel_tier3_2_c",

	questName = "tatooine_rebel_tier3_2_c",
	questType = "escort",
	...
	parentQuest = "survival_tatooine_rebel_tier3_2_b",
	parentQuestType = "survival",
	parentQuestName = "tatooine_rebel_tier3_2_b",
...
registerScreenPlay("escort_tatooine_rebel_tier3_2_c", true)
...
delivery_tatooine_rebel_tier3_3 = SpaceDeliveryScreenplay:new {
	...
	sideQuest = true,
	sideQuestType = "assassinate",
	sideQuestName = "tatooine_rebel_tier3_3_a",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	pickupShip = "nym_smuggler",
	deliveryShip = "reb_gunboat_tier3",

	pickupPoint = "space_endor:tatooine_rebel_tier_3_3_pickup",
	deliveryPoint = "space_endor:tatooine_rebel_tier_3_3_deliver",
...
assassinate_tatooine_rebel_tier3_3_a = SpaceAssassinateScreenplay:new {
	className = "assassinate_tatooine_rebel_tier3_3_a",

	questType = "assassinate",
	questName = "tatooine_rebel_tier3_3_a",
	...
	sideQuest = true,
	sideQuestType = "space_battle",
	sideQuestName = "tatooine_rebel_tier3_3_b",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "delivery_tatooine_rebel_tier3_3",
	parentQuestType = "delivery",
	parentQuestName = "tatooine_rebel_tier3_3",
	...
	targetPatrols = {
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_1", zoneName = "space_endor", x = 2940, z = -4680, y = 1200},
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_2", zoneName = "space_endor", x = 2922, z = -3692, y = 1654},
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_3", zoneName = "space_endor", x = 2900, z = -2445, y = 2228},
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_4", zoneName = "space_endor", x = 2892, z = -1093, y = 2859},
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_5", zoneName = "space_endor", x = 2892, z = 55, y = 3394},
		{patrolPointName = "tatooine_rebel_tier3_3_a_spyship_6", zoneName = "space_endor", x = 2892, z = 1122, y = 3890},
	},
}

registerScreenPlay("assassinate_tatooine_rebel_tier3_3_a", true)

-- Mission 3 Side Quest B: Space Battle (Space Endor - Assist Green squadron against TIE wing)
space_battle_tatooine_rebel_tier3_3_b = SpaceBattleScreenplay:new {
	className = "space_battle_tatooine_rebel_tier3_3_b",

	questName = "tatooine_rebel_tier3_3_b",
	questType = "space_battle",
	...
	sideQuest = true,
	sideQuestType = "escort",
	sideQuestName = "tatooine_rebel_tier3_3_c",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "assassinate_tatooine_rebel_tier3_3_a",
	parentQuestType = "assassinate",
	parentQuestName = "tatooine_rebel_tier3_3_a",

	battlePoint = "space_endor:tatooine_rebel_tier3_3_b_battlepoint",
	allyArrivalDelay = 60,
...
registerScreenPlay("space_battle_tatooine_rebel_tier3_3_b", true)

-- Mission 3 Side Quest C: Escort (Space Endor - Escort Rebel smuggler transporting fleet repair materials)
escort_tatooine_rebel_tier3_3_c = SpaceEscortScreenplay:new {
	className = "escort_tatooine_rebel_tier3_3_c",

	questName = "tatooine_rebel_tier3_3_c",
	questType = "escort",
	...
	parentQuest = "space_battle_tatooine_rebel_tier3_3_b",
	parentQuestType = "space_battle",
	parentQuestName = "tatooine_rebel_tier3_3_b",

	escortShips = {"rebel_smuggler_tier3"},

	escortPoints = {
		{patrolPointName = "tatooine_rebel_tier3_3_c_escort_1", zoneName = "space_endor", x = -5250, z = -850, y = 2000, escortNumber = 1, radius = 250},
		{patrolPointName = "tatooine_rebel_tier3_3_c_escort_2", zoneName = "space_endor", x = -4323, z = -525, y = 2310, escortNumber = 2, radius = 250},
		{patrolPointName = "tatooine_rebel_tier3_3_c_escort_3", zoneName = "space_endor", x = -3632, z = -680, y = 1552, escortNumber = 3, radius = 250},
		{patrolPointName = "tatooine_rebel_tier3_3_c_escort_4", zoneName = "space_endor", x = -2813, z = -400, y = 1793, escortNumber = 4, radius = 250},
	},
...
registerScreenPlay("escort_tatooine_rebel_tier3_3_c", true)
...
assassinate_tatooine_rebel_tier3_4 = SpaceAssassinateScreenplay:new {
	...
	sideQuest = true,
	sideQuestType = "patrol",
	sideQuestName = "tatooine_rebel_tier3_4_a",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,
	...
	targetPatrols = {
		{patrolPointName = "tatooine_rebel_tier3_4_assassin_1", zoneName = "space_dathomir"},
		{patrolPointName = "tatooine_rebel_tier3_4_assassin_2", zoneName = "space_dathomir"},
		{patrolPointName = "tatooine_rebel_tier3_4_assassin_3", zoneName = "space_dathomir"},
		{patrolPointName = "tatooine_rebel_tier3_4_assassin_4", zoneName = "space_dathomir"},
	},
}
...
patrol_tatooine_rebel_tier3_4_a = SpacePatrolScreenplay:new {
	className = "patrol_tatooine_rebel_tier3_4_a",

	questName = "tatooine_rebel_tier3_4_a",
	questType = "patrol",
	...
	sideQuest = true,
	sideQuestType = "destroy_surpriseattack",
	sideQuestName = "tatooine_rebel_tier3_4_b",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.PATROL_POINT,

	sideQuestPatrolStart = 3,
	sideQuestDelay = 5,

	parentQuest = "assassinate_tatooine_rebel_tier3_4",
	parentQuestType = "assassinate",
	parentQuestName = "tatooine_rebel_tier3_4",

	patrolPoints = {
		{patrolPointName = "tatooine_rebel_tier3_4_a_patrol_1", x = -3960, z = -400, y = -4950, patrolNumber = 1, radius = 150},
		{patrolPointName = "tatooine_rebel_tier3_4_a_patrol_2", x = -3758, z = 345, y = -4588, patrolNumber = 2, radius = 150},
		{patrolPointName = "tatooine_rebel_tier3_4_a_patrol_3", x = -3460, z = 37, y = -3563, patrolNumber = 3, radius = 150},
		{patrolPointName = "tatooine_rebel_tier3_4_a_patrol_4", x = -2777, z = 778, y = -3350, patrolNumber = 4, radius = 150},
	},
}

registerScreenPlay("patrol_tatooine_rebel_tier3_4_a", true)

-- Mission 4 Side Quest B: Destroy Surprise Attack (Space Endor - Imperial Elite Ambush squad)
destroy_surpriseattack_tatooine_rebel_tier3_4_b = SpaceSurpriseAttackScreenplay:new {
	className = "destroy_surpriseattack_tatooine_rebel_tier3_4_b",

	questName = "tatooine_rebel_tier3_4_b",
	questType = "destroy_surpriseattack",
	...
	sideQuest = true,
	sideQuestType = "space_battle",
	sideQuestName = "tatooine_rebel_tier3_4_c",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "patrol_tatooine_rebel_tier3_4_a",
	parentQuestType = "patrol",
	parentQuestName = "tatooine_rebel_tier3_4_a",
...
registerScreenPlay("destroy_surpriseattack_tatooine_rebel_tier3_4_b", true)

-- Mission 4 Side Quest C: Space Battle (Space Endor - Assist Blue Squadron attacking TIE bomber wing)
space_battle_tatooine_rebel_tier3_4_c = SpaceBattleScreenplay:new {
	className = "space_battle_tatooine_rebel_tier3_4_c",

	questName = "tatooine_rebel_tier3_4_c",
	questType = "space_battle",
	...
	sideQuest = true,
	sideQuestType = "survival",
	sideQuestName = "tatooine_rebel_tier3_4_d",
	sideQuestSplitType = SpaceQuestLogic.SIDE_QUEST_SPLIT_TYPES.COMPLETION,

	sideQuestDelay = 0,

	parentQuest = "destroy_surpriseattack_tatooine_rebel_tier3_4_b",
	parentQuestType = "destroy_surpriseattack",
	parentQuestName = "tatooine_rebel_tier3_4_b",

	battlePoint = "space_endor:tatooine_rebel_tier3_4_c_battlepoint",
	allyArrivalDelay = 60,
...
registerScreenPlay("space_battle_tatooine_rebel_tier3_4_c", true)

-- Mission 4 Side Quest D: Survival (Space Endor - Guard fleet flank during hyperspace evacuation)
survival_tatooine_rebel_tier3_4_d = SpaceSurvivalScreenplay:new {
	className = "survival_tatooine_rebel_tier3_4_d",

	questName = "tatooine_rebel_tier3_4_d",
	questType = "survival",
	...
	parentQuest = "space_battle_tatooine_rebel_tier3_4_c",
	parentQuestType = "space_battle",
	parentQuestName = "tatooine_rebel_tier3_4_c",

	survivalTime = 300,
	survivalPoint = "space_endor:tatooine_rebel_tier3_4_c_survival",
	delayToFirstAttack = 5,
...
registerScreenPlay("survival_tatooine_rebel_tier3_4_d", true)
...
recovery_tatooine_rebel_tier4_4 = SpaceRecoveryScreenplay:new {
	...
	sideQuestType2 = "rescue",
	sideQuestName2 = "tatooine_rebel_tier4_4_b",
...
rescue_duty_tatooine_rebel_tier4_1 = SpaceDutyRescueScreenplay:new {
	...
	recoveryPoints = {
		{patrolPointName = "tatooine_rebel_tier4_1_rescue_duty_1", zoneName = "space_dantooine", radius = 250},
...
CrimsonPhoenixSquadronScreenplay = ScreenPlay:new {
	...
	-- Tier 2
	TIER2_QUEST_STRING_1 = {type = "inspect", name = "tatooine_rebel_tier2_1"},
	TIER2_QUEST_STRING_2 = {type = "escort", name = "tatooine_rebel_tier2_2"},
	TIER2_QUEST_STRING_3 = {type = "recovery", name = "tatooine_rebel_tier2_3"},
	TIER2_QUEST_STRING_4 = {type = "assassinate", name = "tatooine_rebel_tier2_4"},
	TIER2_QUEST_STRING_DUTY_1 = {type = "destroy_duty", name = "tatooine_rebel_tier2_destroyduty"},
	TIER2_QUEST_STRING_DUTY_2 = {type = "recovery_duty", name = "tatooine_rebel_tier2_recoveryduty"},
	TIER2_QUEST_STRING_DUTY_3 = {type = "escort_duty", name = "tatooine_rebel_tier2_escortduty"},

	-- Tier 3
	TIER3_QUEST_STRING_1 = {type = "recovery", name = "tatooine_rebel_tier3_1"},
	TIER3_QUEST_STRING_1_SIDE1 = {type = "patrol", name = "patrol_tatooine_rebel_tier3_1_A"},
	TIER3_QUEST_STRING_1_SIDE2 = {type = "destroy_surpriseattack", name = "tatooine_rebel_tier3_1_b"},
	TIER3_QUEST_STRING_1_SIDE3 = {type = "assassinate", name = "tatooine_rebel_tier3_1_c"},
	TIER3_QUEST_STRING_1_SIDE4 = {type = "space_battle", name = "tatooine_rebel_tier3_1_d"},
	TIER3_QUEST_STRING_2 = {type = "inspect", name = "tatooine_rebel_tier3_2"},
	TIER3_QUEST_STRING_2_SIDE1 = {type = "delivery", name = "delivery_tatooine_rebel_tier3_2_a"},
	TIER3_QUEST_STRING_2_SIDE2 = {type = "survival", name = "tatooine_rebel_tier3_2_b"},
	TIER3_QUEST_STRING_2_SIDE3 = {type = "escort", name = "tatooine_rebel_tier3_2_c"},
	TIER3_QUEST_STRING_3 = {type = "delivery", name = "tatooine_rebel_tier3_3"},
	TIER3_QUEST_STRING_3_SIDE1 = {type = "assassinate", name = "tatooine_rebel_tier3_3_a"},
	TIER3_QUEST_STRING_3_SIDE2 = {type = "space_battle", name = "tatooine_rebel_tier3_3_b"},
	TIER3_QUEST_STRING_3_SIDE3 = {type = "escort", name = "tatooine_rebel_tier3_3_c"},
	TIER3_QUEST_STRING_4 = {type = "assassinate", name = "tatooine_rebel_tier3_4"},
	TIER3_QUEST_STRING_4_SIDE1 = {type = "patrol", name = "patrol_tatooine_rebel_tier3_4_a"},
	TIER3_QUEST_STRING_4_SIDE2 = {type = "destroy_surpriseattack", name = "tatooine_rebel_tier3_4_b"},
	TIER3_QUEST_STRING_4_SIDE3 = {type = "space_battle", name = "tatooine_rebel_tier3_4_c"},
	TIER3_QUEST_STRING_4_SIDE4 = {type = "survival", name = "tatooine_rebel_tier3_4_d"},

	-- Tier 4
	TIER4_QUEST_STRING_1 = {type = "survival", name = "tatooine_rebel_tier4_1"},
	TIER4_QUEST_STRING_1_SIDE1 = {type = "space_battle", name = "space_battle_tatooine_rebel_tier4_1_a"},
	TIER4_QUEST_STRING_1_SIDE2 = {type = "space_battle", name = "space_battle_tatooine_rebel_tier4_1_b"},
	TIER4_QUEST_STRING_2 = {type = "assassinate", name = "tatooine_rebel_tier4_2"},
	TIER4_QUEST_STRING_2_SIDE1 = {type = "delivery_no_pickup", name = "delivery_no_pickup_tatooine_rebel_tier4_2_a"},
	TIER4_QUEST_STRING_2_SIDE2 = {type = "rescue", name = "rescue_tatooine_rebel_tier4_2_b"},
	TIER4_QUEST_STRING_3 = {type = "space_battle", name = "tatooine_rebel_tier4_3"},
	TIER4_QUEST_STRING_3_SIDE1 = {type = "space_battle", name = "space_battle_tatooine_rebel_tier4_3_a"},
	TIER4_QUEST_STRING_3_SIDE2 = {type = "survival", name = "survival_tatooine_rebel_tier4_3_b"},
	TIER4_QUEST_STRING_4 = {type = "recovery", name = "tatooine_rebel_tier4_4"},
	TIER4_QUEST_STRING_4_SIDE1 = {type = "assassinate", name = "assassinate_tatooine_rebel_tier4_4_a"},
	TIER4_QUEST_STRING_4_SIDE2 = {type = "rescue", name = "rescue_tatooine_rebel_tier4_4_b"},
	...
	TIER4_QUEST_STRING_DUTY_2 = {type = "rescue_duty", name = "tatooine_rebel_tier4_1"},
	TIER4_QUEST_STRING_DUTY_3 = {type = "recovery_duty", name = "tatooine_rebel_tier4_1"},
	TIER4_QUEST_STRING_DUTY_4 = {type = "destroy_duty", name = "tatooine_rebel_tier4_1"},
}
...
function CrimsonPhoenixSquadronScreenplay:resetSocunaQuests(pPlayer)
	...
	removeQuestStatus(playerID .. "CrimsonPhoenixSquadronScreenplay:socuna_finished")
	removeQuestStatus(playerID .. CrimsonPhoenixSquadronScreenplay.QUEST_STRING_1.name .. ":attempted")
	removeQuestStatus(playerID .. CrimsonPhoenixSquadronScreenplay.QUEST_STRING_2.name .. ":attempted")
	removeQuestStatus(playerID .. CrimsonPhoenixSquadronScreenplay.QUEST_STRING_3.name .. ":attempted")
	removeQuestStatus(playerID .. CrimsonPhoenixSquadronScreenplay.QUEST_STRING_4.name .. ":attempted")
...
function CrimsonPhoenixSquadronScreenplay:resetTier2Quests(pPlayer)
	...
	removeQuestStatus(playerID .. "CrimsonPhoenixSquadron:tier2Smuggler")
end

function CrimsonPhoenixSquadronScreenplay:resetTier3Quests(pPlayer)
	if (pPlayer == nil) then
		return
	end
	...
	patrol_tatooine_rebel_tier3_1_A:resetQuest(pPlayer)
	destroy_surpriseattack_tatooine_rebel_tier3_1_b:resetQuest(pPlayer)
	assassinate_tatooine_rebel_tier3_1_c:resetQuest(pPlayer)
	space_battle_tatooine_rebel_tier3_1_d:resetQuest(pPlayer)
	...
	delivery_tatooine_rebel_tier3_2_a:resetQuest(pPlayer)
	survival_tatooine_rebel_tier3_2_b:resetQuest(pPlayer)
	escort_tatooine_rebel_tier3_2_c:resetQuest(pPlayer)
	...
	assassinate_tatooine_rebel_tier3_3_a:resetQuest(pPlayer)
	space_battle_tatooine_rebel_tier3_3_b:resetQuest(pPlayer)
	escort_tatooine_rebel_tier3_3_c:resetQuest(pPlayer)
	...
	patrol_tatooine_rebel_tier3_4_a:resetQuest(pPlayer)
	destroy_surpriseattack_tatooine_rebel_tier3_4_b:resetQuest(pPlayer)
	space_battle_tatooine_rebel_tier3_4_c:resetQuest(pPlayer)
	survival_tatooine_rebel_tier3_4_d:resetQuest(pPlayer)
...
function CrimsonPhoenixSquadronScreenplay:resetTier4Quests(pPlayer)
	if (pPlayer == nil) then
		return
	end
