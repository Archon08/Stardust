...
#endif
						thisZone->getInRangeObjects(getWorldPositionX(), getWorldPositionZ(), getWorldPositionY(), ZoneServer::CLOSEOBJECTRANGE, &closeSceneObjects, true);
...
bool CreatureObjectImplementation::isAggressiveTo(TangibleObject* target) {
	...
	CreatureObject* object = target->asCreatureObject();
...
// ===== P2: ported missing method implementations from upstream (link-stage undefined symbols) =====
